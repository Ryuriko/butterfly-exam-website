              ...
              @csrf
                <div class="row m-0">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control p-3 border border-dark @error('identity_code')is-invalid @enderror" id="identity_code" name="identity_code" autofocus required value="{{old('identity_code')}}">
                        @error('identity_code')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
